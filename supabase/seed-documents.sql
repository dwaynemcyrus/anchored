...
BEGIN
  ...
  INSERT INTO documents (id, user_id, title, slug, content_type, visibility, status, body_md, summary, metadata, published_at) VALUES
...
-- Verify the seed
SELECT id, title, content_type, visibility, status, published_at
FROM documents
